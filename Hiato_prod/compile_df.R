...
source(paste0(path,"data/PIBTRIM1_pib.R"), local = TRUE)
pib_tri_dsz <- pib_tri_dsz[,c("datas", "val_add")]
...
t <- seq(as.Date("2001-03-01"), as.Date("2019-01-01"), by = "quarter")

Y  <- ts(pib_tri_dsz$val_add, freq=4, start=c(1996, 1));    Y <- window(Y, start=2001, end=2019)
